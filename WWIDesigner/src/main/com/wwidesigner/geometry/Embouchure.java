...
public class Embouchure extends Component implements EmbouchureInterface {
     ...
     *      double)
	 * @see com.wwidesigner.geometry.EmbouchureInterface#calcT(com.wwidesigner.math.TransferMatrix, double)
	 */
    @Override
	 ...
	 * @see com.wwidesigner.geometry.EmbouchureInterface#validate()
	 */
    @Override
