...
public class Hole extends Component implements HoleInterface
{
     ...
     *      double)
	 * @see com.wwidesigner.impedance.geometry.HoleInterface#calcT(com.wwidesigner.impedance.math.TransferMatrix, double)
	 */
    @Override
	 ...
	 * @see com.wwidesigner.impedance.geometry.HoleInterface#validate()
	 */
    @Override
