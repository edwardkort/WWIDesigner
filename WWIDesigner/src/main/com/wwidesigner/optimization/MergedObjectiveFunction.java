...
/**
 * Abstract class for classes that merge multiple ObjectiveFunctions
 * into a single objective function.
 * The number of geometry dimensions is the sum of the dimensions
 * of the individual classes.
 * The geometry dimensions of the individual ObjectiveFunctions
 * must be independent. 
...
public abstract class MergedObjectiveFunction extends BaseObjectiveFunction
{
	...
	/**
	 * Function to calculate the dimensions of the merged class,
	 * and pull any specific bounds from the components.
	 * Derived classes must call this function at the end of their constructor,
	 * after initializing this.components.
	 */
	...
	/* (non-Javadoc)
	 * @see com.wwidesigner.optimization.BaseObjectiveFunction#getGeometryPoint()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.wwidesigner.optimization.BaseObjectiveFunction#setGeometryPoint(double[])
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.wwidesigner.optimization.BaseObjectiveFunction#setLowerBounds(double[])
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.wwidesigner.optimization.BaseObjectiveFunction#setUpperBounds(double[])
	 */
	@Override
