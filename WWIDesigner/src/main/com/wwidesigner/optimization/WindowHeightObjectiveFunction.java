...
public class WindowHeightObjectiveFunction extends BaseObjectiveFunction
{
	...
	public WindowHeightObjectiveFunction(InstrumentCalculator calculator, TuningInterface tuning,
	...
	public double[] getGeometryPoint()
	{
		...
		geometry[0] = calculator.getInstrument().getMouthpiece().getFipple().getWindowHeight();
		return geometry;
	}
	...
	public void setGeometryPoint(double[] point)
	{
		...
		calculator.getInstrument().getMouthpiece().getFipple().setWindowHeight( point[0] );
