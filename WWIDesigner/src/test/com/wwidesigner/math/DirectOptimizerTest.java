...
public class DirectOptimizerTest extends StandardOptimizerTest
{
	...
	{
		final int N = 4;	// DIRECT can't handle more than 4.
		...
		// Test that optimum and optimizer point are correct.
		// DIRECT doesn't even come close.
