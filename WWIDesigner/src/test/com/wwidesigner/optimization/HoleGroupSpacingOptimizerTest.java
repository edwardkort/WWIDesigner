...
public class HoleGroupSpacingOptimizerTest extends AbstractOptimizationTest
{
	...
	public void testNoGroupingNAF()
	{
		try
		{
			...
			setup();
			lowerBound = new double[] { 0.2, 0.018, 0.018, 0.018, 0.018, 0.018,
					0.0005, 0.018, 0.0025, 0.0025, 0.0025, 0.0025, 0.0025,
					0.0025, 0.0025 };
			upperBound = new double[] { 0.5, 0.05, 0.05, 0.1, 0.05, 0.05, 0.003,
					0.20, 0.017, 0.017, 0.017, 0.017, 0.017, 0.010, 0.010 };
	...
	public void test2GroupingNAF()
	{
		try
		{
			...
			Instrument optimizedInstrument = doInstrumentOptimization(
					"Two hole groups, NAF Calculator");
